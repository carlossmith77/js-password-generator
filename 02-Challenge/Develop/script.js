...
function determineUppercase(){
  uppercaseCheck = prompt("Do you want to include uppercase letters in your password? \n(Y or N)");
    ...
    }else if (uppercaseCheck === "y" || uppercaseCheck ==="y"){
      uppercaseCheck = true;
      return uppercaseCheck;

    }else if (uppercaseCheck === "n" || uppercaseCheck ==="n"){
...
function determineNumbers(){
  numberCheck = prompt("Do you want to include numbers in your password? \n(Y or N)");
    ...
    }else if (numberCheck === "y" || numberCheck ==="y"){
      numberCheck = true;
      return numberCheck;

    }else if (numberCheck === "n" || numberCheck ==="n"){
      numberCheck = false;
      return numberCheck;
...
function determineSpecial(){
  specialCheck = prompt("Do you want to include special characters in your password? \n(Y or N)");
    ...
    }else if (specialCheck === "y" || specialCheck ==="y"){
      specialCheck = true;
      return specialCheck;

    }else if (specialCheck === "n" || specialCheck ==="n"){
      specialCheck = false;
      return specialCheck;
